...
public class GlobalExceptionHandler {
	...
	public ResponseEntity<ExceptionDTO> accountExceptionHandler(AccountException e, WebRequest wr){
	...
	public ResponseEntity<ExceptionDTO> userExceptionHandler(UserException e, WebRequest wr){
	...
	public ResponseEntity<ExceptionDTO> amountExceptionHandler(AmountException e, WebRequest wr){
